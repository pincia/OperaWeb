...
import CustomTaskTreeView from './CustomTaskTreeView';
import TaskDetailsDialog from './TaskDetailsDialog';
import EntryDetailsDialog from './EntryDetailsDialog';
import CustomEntryList from './EntryList';

export default function CustomTasksForm({ projectData, setProjectData, onValidationChange }) {
