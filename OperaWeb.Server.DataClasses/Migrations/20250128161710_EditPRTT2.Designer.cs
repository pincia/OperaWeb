...
namespace OperaWeb.Server.DataClasses.Migrations
{
    ...
    [Migration("20250128161710_EditPRTT2")]
    partial class EditPRTT2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OperaWeb.Server.DataClasses.Models.Configuration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ConfigNumeriId")
                        .HasColumnType("int");

                    b.Property<int>("ProjectResourceTeamTypeId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("AnalisiId");

                    b.HasIndex("ApplicationUserId");

                    b.HasIndex("ConfigNumeriId");

                    b.HasIndex("ProjectResourceTeamTypeId");
            ...
            modelBuilder.Entity("OperaWeb.Server.DataClasses.Models.ProjectResourceTeamType", b =>
                {
                    ...
                    b.Property<decimal>("CommonHourlyRate")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<int>("CommonQuantity")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("SpecializedHourlyRate")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<int>("SpecializedQuantity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OperaWeb.Server.DataClasses.Models.Configuration", b =>
                {
                    b.HasOne("OperaWeb.Server.DataClasses.Models.Analisi", "Analisi")
                        .WithMany()
                        .HasForeignKey("AnalisiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("OperaWeb.Server.DataClasses.Models.ConfigNumeri", "ConfigNumeri")
                        .WithMany()
                        .HasForeignKey("ConfigNumeriId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OperaWeb.Server.DataClasses.Models.ProjectResourceTeamType", "ProjectResourceTeamType")
                        .WithMany()
                        .HasForeignKey("ProjectResourceTeamTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
